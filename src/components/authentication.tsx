...
export default function Authentication({ onClick }: Props) {
    return <div className="w-1/5">
        <Card>
            <Image width={128} height={128} className="h-32 w-32 rounded-full border-4 border-white dark:border-gray-800 mx-auto my-4" src="https://cdn.freebiesupply.com/logos/large/2x/random-logo-png-transparent.png" alt="" />
