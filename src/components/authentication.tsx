...
export default function Authentication({ onClick }: Props) {
    return <div className="w-1/4">
        <Card>
            <img className="h-32 w-32 rounded-full border-4 border-white dark:border-gray-800 mx-auto my-4" src="https://www.lego.com/cdn/cs/set/assets/blta636ffccc87fdf4b/60367.png?format=webply&fit=bounds&quality=75&width=1200&height=1200&dpr=1" alt="" />
