"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[220],{57350:function(e,t,r){r.d(t,{C:function(){return signOut},X:function(){return GoogleAuthProvider},c:function(){return signInWithPopup},o:function(){return getAuth}});var i=r(8745),n=r(63991),s=r(56914),a=r(50044),o=r(45538);function _prodErrorMap(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let l=_prodErrorMap,c=new i.LL("auth","Firebase",_prodErrorMap()),u=new s.Yd("@firebase/auth");function _logWarn(e,...t){u.logLevel<=s.in.WARN&&u.warn(`Auth (${n.Jn}): ${e}`,...t)}function _logError(e,...t){u.logLevel<=s.in.ERROR&&u.error(`Auth (${n.Jn}): ${e}`,...t)}/**
 * @license
